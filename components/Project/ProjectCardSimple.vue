        ...
        <div relative flex items-center justify-between>
          <div flex items-center gap-3>
            <h3
              ...
              transition
              duration-300
              class="rounded-sm px-1 py-0.5 pb-0.5 underline decoration-transparent decoration-offset-3 decoration-wavy -mx-0.5 -my-0.5 group-hover:decoration-default-3 dark:group-hover:decoration-accent"
            >
              {{ project.name }}
            </h3>
